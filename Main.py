...
def main(M=0, R=0, graph=0, viz=0):
    # --------------------------------------------------------------------------
    ##TAD
    # si M et R ne sont pas défini, lance l'UI
    if (M == 0 & R == 0):
        GUI.main()
    ...
    #evalue la première méthode de hachage
    ...
    # evalue la méthode de hachage de Jenkins
    ...
    # evalue la methode de hachage par multiplication
